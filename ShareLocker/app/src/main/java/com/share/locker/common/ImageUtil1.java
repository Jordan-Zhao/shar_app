...
public class ImageUtil {
	...
	private static String baseUrl = "C:\\dev\\IDE\\apache-tomcat-8.5.24\\wtpwebapps\\images\\";

	public static void main(String[] args) throws IOException {

		*/
/*
		 * File fileOne = new File(baseUrl+"a.jpg"); BufferedImage imageFirst =
...
/**
	...
	public static void zoomByWidth(InputStream inputFileStream, int targetWidth, String targetFilePath) {
		try {
...
/*
		 ...
		 * targetW, targetH); } else if ((width < targetW && width == height) || (height
		 * < targetH && width == height)) { return zoomInImage(source, targetW,
		 * targetH); } return null;
		 *//*
